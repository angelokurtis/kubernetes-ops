...
provider "kubernetes" {
  host = kind_cluster.istio_cluster.endpoint

  client_certificate     = kind_cluster.istio_cluster.client_certificate
  client_key             = kind_cluster.istio_cluster.client_key
  cluster_ca_certificate = kind_cluster.istio_cluster.cluster_ca_certificate
}
