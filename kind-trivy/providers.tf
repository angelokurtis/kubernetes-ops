...
provider "kubernetes" {
  host = kind_cluster.trivy.endpoint

  client_certificate     = kind_cluster.trivy.client_certificate
  client_key             = kind_cluster.trivy.client_key
  cluster_ca_certificate = kind_cluster.trivy.cluster_ca_certificate
}
